...
const WIDTH = 1080;
const HEIGHT = 1920;
function useSlideProgress(durationInFrames) {
  const frame = (0,esm/* useCurrentFrame */.UC)();
  const progress = Math.min(frame / durationInFrames, 1);
  return { frame, progress };
}
function Slide1({ durationInFrames }) {
  const { frame } = useSlideProgress(durationInFrames);
  const titleY = (0,esm/* interpolate */.GW)(frame, [0, 40], [200, 0], {
    extrapolateRight: "clamp",
    easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
  });
  const subtitleOpacity = (0,esm/* interpolate */.GW)(frame, [20, 60], [0, 1], {
    extrapolateRight: "clamp"
  });
  const bgScale = (0,esm/* interpolate */.GW)(frame, [0, 150], [1, 1.2], {
    extrapolateRight: "clamp",
    easing: esm/* Easing */.GS.linear
  });
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)("audio-0.mp3") }),
    particles.map((p, i) => {
    ...
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          ...
          width: "200%",
          height: "200%",
          backgroundImage: "linear-gradient(rgba(100, 200, 255, 0.03) 1px, transparent 1px), linear-gradient(90deg, rgba(100, 200, 255, 0.03) 1px, transparent 1px)",
    ...
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          position: "absolute",
          bottom: 200,
          width: (0,esm/* interpolate */.GW)(frame, [40, 100], [0, 400], {
            extrapolateRight: "clamp"
          }),
          height: 2,
...
function Slide2({ durationInFrames }) {
  const { frame } = useSlideProgress(durationInFrames);
  const titleX = (0,esm/* interpolate */.GW)(frame, [0, 30], [-100, 0], {
    extrapolateRight: "clamp",
    easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
  });
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)("audio-1.mp3") }),
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
    ...
    items.map((item, i) => {
      const itemY = (0,esm/* interpolate */.GW)(frame, [20 + i * 20, 50 + i * 20], [100, 0], {
        extrapolateRight: "clamp",
        easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
      });
      const itemOpacity = (0,esm/* interpolate */.GW)(frame, [20 + i * 20, 50 + i * 20], [0, 1], {
        extrapolateRight: "clamp"
      });
      return /* @__PURE__ */ react.createElement(
        "div",
...
function Slide3({ durationInFrames }) {
  const { frame } = useSlideProgress(durationInFrames);
  const cards = [
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)("audio-2.mp3") }),
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          ...
          marginBottom: 80,
          textAlign: "center",
          opacity: (0,esm/* interpolate */.GW)(frame, [0, 30], [0, 1], {
            extrapolateRight: "clamp"
          }),
          fontFamily: "'PingFang SC','Helvetica Neue',sans-serif"
        }
    ...
    cards.map((card, i) => {
      const cardY = (0,esm/* interpolate */.GW)(frame, [15 + i * 15, 45 + i * 15], [150, 0], {
        extrapolateRight: "clamp",
        easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
      });
      const cardOpacity = (0,esm/* interpolate */.GW)(frame, [15 + i * 15, 45 + i * 15], [0, 1], {
        extrapolateRight: "clamp"
      });
      const cardScale = (0,esm/* interpolate */.GW)(frame, [15 + i * 15, 45 + i * 15], [0.8, 1], {
        extrapolateRight: "clamp",
        easing: esm/* Easing */.GS.out(esm/* Easing */.GS.back(1.2))
      });
      return /* @__PURE__ */ react.createElement(
        "div",
        {
...
function Slide4({ durationInFrames }) {
  const { frame } = useSlideProgress(durationInFrames);
  const scenes = [
    { title: "\u8BED\u97F3\u52A9\u624B", icon: "\u{1F3A4}", color: "#a855f7" },
    { title: "\u81EA\u52A8\u9A7E\u9A76", icon: "\u{1F697}", color: "#3b82f6" },
    { title: "\u533B\u7597\u8BCA\u65AD", icon: "\u{1F3E5}", color: "#10b981" }
  ];
  return /* @__PURE__ */ react.createElement(
    esm/* AbsoluteFill */.H1,
    {
    ...
    /* @__PURE__ */ react.createElement(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)("audio-3.mp3") }),
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
    ...
    /* @__PURE__ */ react.createElement(
      ...
      scenes.map((scene, i) => {
        const itemX = (0,esm/* interpolate */.GW)(frame, [20 + i * 18, 50 + i * 18], [i % 2 === 0 ? -200 : 200, 0], {
          extrapolateRight: "clamp",
          easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
        });
        const itemOpacity = (0,esm/* interpolate */.GW)(frame, [20 + i * 18, 50 + i * 18], [0, 1], {
          extrapolateRight: "clamp"
        });
        const itemRotate = (0,esm/* interpolate */.GW)(frame, [20 + i * 18, 50 + i * 18], [i % 2 === 0 ? -10 : 10, 0], {
          extrapolateRight: "clamp",
          easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
        });
        return /* @__PURE__ */ react.createElement(
...
function Slide5({ durationInFrames }) {
  const { frame } = useSlideProgress(durationInFrames);
  const bars = [
  ...
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)("audio-4.mp3") }),
    /* @__PURE__ */ react.createElement(
      "div",
      {
        style: {
          ...
          marginBottom: 100,
          textAlign: "center",
          opacity: (0,esm/* interpolate */.GW)(frame, [0, 25], [0, 1], {
            extrapolateRight: "clamp"
          }),
          fontFamily: "'PingFang SC','Helvetica Neue',sans-serif"
        }
    ...
    /* @__PURE__ */ react.createElement(
      ...
      bars.map((bar, i) => {
        const barHeight = (0,esm/* interpolate */.GW)(frame, [20 + i * 15, 50 + i * 15], [0, bar.value / 100 * maxBarHeight], {
          extrapolateRight: "clamp",
          easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
        });
        const barOpacity = (0,esm/* interpolate */.GW)(frame, [20 + i * 15, 50 + i * 15], [0, 1], {
          extrapolateRight: "clamp"
        });
        return /* @__PURE__ */ react.createElement(
          "div",
...
function Slide6({ durationInFrames }) {
  const { frame } = useSlideProgress(durationInFrames);
  ...
  const bgPulse = (0,esm/* interpolate */.GW)(frame, [0, 60], [1, 1.1], {
    extrapolateRight: "clamp",
    easing: esm/* Easing */.GS.linear
  });
  return /* @__PURE__ */ react.createElement(
    ...
    /* @__PURE__ */ react.createElement(esm/* Audio */.fP, { src: (0,esm/* staticFile */.dQ)("audio-5.mp3") }),
    circles.map((circle, i) => {
      const scale = (0,esm/* interpolate */.GW)(frame, [circle.delay, circle.delay + 40], [0, 1], {
        extrapolateRight: "clamp",
        easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
      });
      const opacity = (0,esm/* interpolate */.GW)(frame, [circle.delay + 20, circle.delay + 60], [0.6, 0], {
        extrapolateRight: "clamp"
      });
      return /* @__PURE__ */ react.createElement(
        "div",
      ...
      /* @__PURE__ */ react.createElement(
        "div",
        {
          style: {
            ...
            opacity: (0,esm/* interpolate */.GW)(frame, [0, 40], [0, 1], {
              extrapolateRight: "clamp"
            }),
            transform: `scale(${(0,esm/* interpolate */.GW)(frame, [0, 40], [0.8, 1], {
              extrapolateRight: "clamp",
              easing: esm/* Easing */.GS.out(esm/* Easing */.GS.cubic)
            })})`,
            fontFamily: "'PingFang SC','Helvetica Neue',sans-serif",
      ...
      /* @__PURE__ */ react.createElement(
        "div",
        {
          style: {
            fontSize: 42,
            color: "#64c8ff",
            opacity: (0,esm/* interpolate */.GW)(frame, [25, 55], [0, 1], {
              extrapolateRight: "clamp"
            }),
            fontFamily: "'PingFang SC','Helvetica Neue',sans-serif",
            marginBottom: 60
      ...
      /* @__PURE__ */ react.createElement(
        "div",
        {
          style: {
            ...
            fontWeight: "bold",
            color: "#0a0e27",
            transform: `scale(${(0,esm/* interpolate */.GW)(frame, [20, 50], [0.8, 1], {
              extrapolateRight: "clamp",
              easing: esm/* Easing */.GS.out(esm/* Easing */.GS.back(1.5))
            })})`,
            fontFamily: "'PingFang SC','Helvetica Neue',sans-serif"
          }
        },
...
function VideoComposition() {
  ...
  return /* @__PURE__ */ react.createElement(esm/* AbsoluteFill */.H1, null, SLIDES.map((slide, i) => {
    const Component = slide.component;
    return /* @__PURE__ */ react.createElement(esm/* Sequence */.gd, { key: i, from: offsets[i], durationInFrames: slide.durationInFrames }, /* @__PURE__ */ react.createElement(Component, { durationInFrames: slide.durationInFrames }));
  }));
}
...
var renderContent = (Root) => {
  ...
  if (bundleMode.type === "index") {
    ...
    Promise.all(/* import() */[__webpack_require__.e(750), __webpack_require__.e(752), __webpack_require__.e(226)]).then(__webpack_require__.bind(__webpack_require__, 4752)).then(({ StudioInternals }) => {
...
/* harmony export */ });
/* unused harmony exports useCurrentScale, useBufferState, spring, prefetch, measureSpring, isHtmlInCanvasSupported, getStaticFiles, cancelRender, Video, Still, Series, OffthreadVideo, Loop, Img, IFrame, HtmlInCanvas, Html5Video, Html5Audio, Freeze, FolderContext, Folder, Experimental, Config, Artifact, AnimatedImage */
...
/* unused harmony import specifier */ var React32;
/* unused harmony import specifier */ var React40;
/* harmony import */ var react__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(6540);
...
var HtmlInCanvasInner = (0,react__WEBPACK_IMPORTED_MODULE_0__.forwardRef)(({
  ...
  const chainState = useEffectChainState();
  const effectsRef = (0,react__WEBPACK_IMPORTED_MODULE_0__.useRef)(experimentalEffects);
...
/******/ 	(() => {
/******/ 		var inProgress = {};
/******/ 		var dataWebpackPrefix = "@thinkflow/video-nextjs:";
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunk_thinkflow_video_nextjs"] = self["webpackChunk_thinkflow_video_nextjs"] || [];
